...
AddOutputFilter chunkFilter
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Iso Measurement.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Iso Measurement/Iso Measurement.lvclass"/>
			<Item Name="Parallel Mode.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Parallel Mode/Parallel Mode.lvclass"/>
			<Item Name="Parameter Set.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Parameter Set/Parameter Set.lvclass"/>
			<Item Name="Cycler.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/High Level Capabilities/Cycler/Cycler.lvclass"/>
