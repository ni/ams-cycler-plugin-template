...
* To intialize and close channels used in the power supply plugin: In Create Channels.vi, wire in the Power Supply Initialize.vi and in Destroy Channels.vi use the Power Supply Close.vi. The BLS capabilities Power Supply high level capabilities Close.vi and Initialize.vi initialize and close all of the VI and classes that are implemented.
